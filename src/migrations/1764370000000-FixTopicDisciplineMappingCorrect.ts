...
export class FixTopicDisciplineMappingCorrect1764370000000
  implements MigrationInterface
{
  name = 'FixTopicDisciplineMappingCorrect1764370000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    console.log('🔧 Исправляю привязку тем к дисциплинам (правильная версия)...');

    // Находим ID дисциплин из базы
    ...
    // Если не найдена, создаём или используем ID из seed-disciplines.ts
    let SPANISH_DISCIPLINE_ID = spanishDisc[0]?.DisciplineID;
    
    if (!SPANISH_DISCIPLINE_ID) {
      // Создаём дисциплину Испанского языка
      SPANISH_DISCIPLINE_ID = 'a3b2c1d0-6e9a-4795-8c0a-0d1e2f3a4b5c';
      ...
      await queryRunner.query(`
        ...
        VALUES ('${SPANISH_DISCIPLINE_ID}', ${nextId}, 'Иностранный язык — Испанский', NOW(), NOW())
    ...
    // Получаем ID остальных дисциплин
