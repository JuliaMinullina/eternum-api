...
/**
 * Миграция для добавления уроков ко всем темам дисциплины "Химия"
 * 
 * Для каждой темы создается детальный план уроков, покрывающий весь материал темы.
 */

export class AddLessonsToChemistry1764700000000
  implements MigrationInterface
{
  name = 'AddLessonsToChemistry1764700000000';
  ...
  /**
   * Получает план уроков для темы химии на основе её названия
   */
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    console.log('🧪 Начинаю добавление уроков для дисциплины "Химия"...');
    ...
    // Получаем все темы для дисциплины "Химия"
    ...
    if (!Array.isArray(topicsResult) || topicsResult.length === 0) {
      console.log('⚠️  Темы для дисциплины "Химия" не найдены');
      return;
    }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    // Удаляем уроки для тем дисциплины "Химия"
    await queryRunner.query(`
      DELETE FROM "lessons"
      WHERE "TopicID" IN (
