...
async function bootstrap() {
  ...
  try {
    ...
    if (existingCount > 0) {
      console.log(
        `⚠️  В базе уже есть ${existingCount} тем по обществознанию. Очищаю темы для этой дисциплины...`,
      );
    ...
    console.log(
      `✅ Успешно создано ${createdTopics.length} тем по обществознанию:`,
    );
    ...
    createdTopics.forEach((topic, index) => {
      ...
      // Категоризация тем
      if (
        topicName.includes('Человек и общество') ||
        topicName.includes('Мировоззрение') ||
        topicName.includes('социализация') ||
        topicName.includes('агенты') ||
        topicName.includes('Проектная деятельность') ||
        topicName.includes('исследовательские')
      ) {
        categorizedTopics['Человек и общество'].push(topicName);
      } else if (
        topicName.includes('Социальная структура') ||
        topicName.includes('стратификация') ||
        topicName.includes('мобильность') ||
        topicName.includes('Малая группа') ||
        topicName.includes('семья') ||
        topicName.includes('брак') ||
        topicName.includes('Этнос') ||
        topicName.includes('нация') ||
        topicName.includes('межкультурные') ||
        topicName.includes('Глобализация') ||
        topicName.includes('Отклоняющееся поведение') ||
        topicName.includes('социальный контроль')
      ) {
        categorizedTopics['Социальная сфера'].push(topicName);
      } else if (
        topicName.includes('Экономика') ||
        topicName.includes('Производство') ||
        topicName.includes('Рынок') ||
        topicName.includes('конкуренция') ||
        topicName.includes('Деньги') ||
        topicName.includes('банки') ||
        topicName.includes('финансовая система') ||
        topicName.includes('налоги') ||
        topicName.includes('бюджет') ||
        topicName.includes('Инфляция') ||
        topicName.includes('безработица') ||
        topicName.includes('Предпринимательство') ||
        topicName.includes('Потребитель') ||
        topicName.includes('финансовая грамотность')
      ) {
        categorizedTopics['Экономическая сфера'].push(topicName);
      } else if (
        topicName.includes('Политика') ||
        topicName.includes('Политическая система') ||
        topicName.includes('Государство') ||
        topicName.includes('гражданское общество') ||
        topicName.includes('Демократия') ||
        topicName.includes('выборы') ||
        topicName.includes('партии') ||
        topicName.includes('РФ') ||
        topicName.includes('Конституция') ||
        topicName.includes('федерализм') ||
        topicName.includes('Международные отношения')
      ) {
        categorizedTopics['Политическая сфера'].push(topicName);
      } else if (
        topicName.includes('Право') ||
        topicName.includes('Отрасли права') ||
        topicName.includes('Правоспособность') ||
        topicName.includes('дееспособность') ||
        topicName.includes('ответственность') ||
        topicName.includes('Сделки') ||
        topicName.includes('собственность') ||
        topicName.includes('Трудовое право') ||
        topicName.includes('Семейное право') ||
        topicName.includes('Защита прав')
      ) {
        categorizedTopics['Правовая сфера'].push(topicName);
      } else if (
        topicName.includes('Культура') ||
        topicName.includes('духовная жизнь') ||
        topicName.includes('Социальные нормы') ||
        topicName.includes('мораль') ||
        topicName.includes('обычаи') ||
        topicName.includes('Коммуникация') ||
        topicName.includes('СМИ') ||
        topicName.includes('общественное мнение')
      ) {
        categorizedTopics['Духовная сфера'].push(topicName);
      } else if (
        topicName.includes('технологии') ||
        topicName.includes('цифровое общество') ||
        topicName.includes('Социальные изменения') ||
        topicName.includes('модернизация') ||
    ...
    console.log(
      `🔗 Привязано к дисциплине: "Обществознание" (${SOCIAL_STUDIES_DISCIPLINE_ID})`,
    );
  } catch (error) {
