...
export class FixPhilosophyToPsychology1764440000000
  implements MigrationInterface
{
  name = 'FixPhilosophyToPsychology1764440000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    console.log('🔧 Перемещаю темы Философии в Психологию...');
    ...
    // Перемещаем темы Философии в Психологию
