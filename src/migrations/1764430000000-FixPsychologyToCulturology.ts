...
export class FixPsychologyToCulturology1764430000000
  implements MigrationInterface
{
  name = 'FixPsychologyToCulturology1764430000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    console.log('🔧 Перемещаю темы Психологии в Культурологию...');
    ...
    // Перемещаем темы Психологии в Культурологию
