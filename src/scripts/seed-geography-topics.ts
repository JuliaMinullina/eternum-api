...
const geographyTopicsData = [
  ...
  },
  {
    ...
    ID: 502,
    TopicName:
      'Картография: масштаб, план местности, картографические проекции',
    DisciplineID: GEOGRAPHY_DISCIPLINE_ID,
    CreatedAt: new Date('2025-08-16T12:00:00Z'),
    UpdatedAt: new Date('2025-08-16T12:00:00Z'),
  },
  ...
  },
  {
    ...
    ID: 504,
    TopicName:
      'Литосфера: строение Земли, тектоника плит, рельеф материков и океанов',
    DisciplineID: GEOGRAPHY_DISCIPLINE_ID,
    CreatedAt: new Date('2025-08-16T12:00:00Z'),
    UpdatedAt: new Date('2025-08-16T12:00:00Z'),
  },
  ...
  },
  {
    ...
    ID: 509,
    TopicName:
      'Гидросфера: Мировой океан, океанические течения, ресурсы океана',
    DisciplineID: GEOGRAPHY_DISCIPLINE_ID,
    CreatedAt: new Date('2025-08-16T12:00:00Z'),
    UpdatedAt: new Date('2025-08-16T12:00:00Z'),
  },
  ...
  },
  {
    ...
    ID: 511,
    TopicName:
      'Биосфера и природные зоны: широтная зональность и высотная поясность',
    DisciplineID: GEOGRAPHY_DISCIPLINE_ID,
    CreatedAt: new Date('2025-08-16T12:00:00Z'),
    UpdatedAt: new Date('2025-08-16T12:00:00Z'),
  },
  ...
  },
  {
    ...
    ID: 514,
    TopicName:
      'Природные опасности и риски: землетрясения, вулканизм, наводнения, засухи',
    DisciplineID: GEOGRAPHY_DISCIPLINE_ID,
    CreatedAt: new Date('2025-08-16T12:00:00Z'),
    UpdatedAt: new Date('2025-08-16T12:00:00Z'),
  },
  {
    ...
    ID: 515,
    TopicName:
      'Население мира: численность, динамика, демографические процессы',
    DisciplineID: GEOGRAPHY_DISCIPLINE_ID,
    CreatedAt: new Date('2025-08-16T12:00:00Z'),
    UpdatedAt: new Date('2025-08-16T12:00:00Z'),
  },
  ...
  },
  {
    ...
    ID: 517,
    TopicName:
      'Мировое хозяйство: структура, специализация, глобальные цепочки',
    DisciplineID: GEOGRAPHY_DISCIPLINE_ID,
    CreatedAt: new Date('2025-08-16T12:00:00Z'),
    UpdatedAt: new Date('2025-08-16T12:00:00Z'),
  },
  ...
  },
  {
    ...
    ID: 524,
    TopicName:
      'Россия: географическое положение, границы, физико-географические условия',
    DisciplineID: GEOGRAPHY_DISCIPLINE_ID,
    CreatedAt: new Date('2025-08-16T12:00:00Z'),
    UpdatedAt: new Date('2025-08-16T12:00:00Z'),
  },
  ...
  },
  {
    ...
    ID: 529,
    TopicName:
      'Охраняемые природные территории и устойчивое природопользование',
    DisciplineID: GEOGRAPHY_DISCIPLINE_ID,
    CreatedAt: new Date('2025-08-16T12:00:00Z'),
    UpdatedAt: new Date('2025-08-16T12:00:00Z'),
  },
...
async function bootstrap() {
  ...
  try {
    ...
    if (existingCount > 0) {
      console.log(
        `⚠️  В базе уже есть ${existingCount} тем по географии. Очищаю темы для этой дисциплины...`,
      );
    ...
    createdTopics.forEach((topic, index) => {
      ...
      // Категоризация тем
      if (
        topicName.includes('География как наука') ||
        topicName.includes('источники, методы')
      ) {
        categorizedTopics['Введение в географию'].push(topicName);
      } else if (
        topicName.includes('Картография') ||
        topicName.includes('ГИС') ||
        topicName.includes('дистанционное зондирование') ||
        topicName.includes('масштаб') ||
        topicName.includes('проекции') ||
        topicName.includes('картографированию')
      ) {
        categorizedTopics['Картография и ГИС'].push(topicName);
      } else if (
        topicName.includes('Земля как планета') ||
        topicName.includes('координаты') ||
        topicName.includes('часовые пояса')
      ) {
        categorizedTopics['Физическая география'].push(topicName);
      } else if (
        topicName.includes('Литосфера') ||
        topicName.includes('тектоника') ||
        topicName.includes('рельеф') ||
        topicName.includes('Рельефообразующие') ||
        topicName.includes('Полезные ископаемые') ||
        topicName.includes('минеральные ресурсы')
      ) {
        categorizedTopics['Литосфера и рельеф'].push(topicName);
      } else if (
        topicName.includes('Атмосфера') ||
        topicName.includes('Погода') ||
        topicName.includes('климат') ||
        topicName.includes('атмосферные')
      ) {
        categorizedTopics['Атмосфера и климат'].push(topicName);
      } else if (
        topicName.includes('Гидросфера') ||
        topicName.includes('океан') ||
        topicName.includes('течения') ||
        topicName.includes('Внутренние воды') ||
        topicName.includes('реки') ||
        topicName.includes('озёра') ||
        topicName.includes('ледники')
      ) {
        categorizedTopics['Гидросфера'].push(topicName);
      } else if (
        topicName.includes('Биосфера') ||
        topicName.includes('природные зоны') ||
        topicName.includes('зональность') ||
        topicName.includes('Почвы') ||
        topicName.includes('земельные ресурсы')
      ) {
        categorizedTopics['Биосфера и почвы'].push(topicName);
      } else if (
        topicName.includes('Природные комплексы') ||
        topicName.includes('ландшафты') ||
        topicName.includes('Природные опасности') ||
        topicName.includes('риски')
      ) {
        categorizedTopics['Природные комплексы'].push(topicName);
      } else if (
        topicName.includes('Население') ||
        topicName.includes('демографические') ||
        topicName.includes('Миграции') ||
        topicName.includes('урбанизация') ||
        topicName.includes('расселение')
      ) {
        categorizedTopics['География населения'].push(topicName);
      } else if (
        topicName.includes('хозяйство') ||
        topicName.includes('Промышленность') ||
        topicName.includes('Сельское хозяйство') ||
        topicName.includes('Транспорт') ||
        topicName.includes('услуг') ||
        topicName.includes('туризма') ||
        topicName.includes('Глобализация') ||
        topicName.includes('торговля')
      ) {
        categorizedTopics['Экономическая география'].push(topicName);
      } else if (
        topicName.includes('Регионы мира') ||
        topicName.includes('материки') ||
        topicName.includes('Страны СНГ')
      ) {
        categorizedTopics['Региональная география'].push(topicName);
      } else if (
        topicName.includes('Россия') ||
        topicName.includes('России') ||
        topicName.includes('Федеральные округа')
      ) {
        categorizedTopics['География России'].push(topicName);
      } else if (
        topicName.includes('Охраняемые') ||
        topicName.includes('природопользование') ||
        topicName.includes('устойчивое')
      ) {
        categorizedTopics['Экология и природопользование'].push(topicName);
      } else if (
        topicName.includes('Полевые') ||
        topicName.includes('геопроекты') ||
    ...
    console.log(
      `🔗 Привязано к дисциплине: "География" (${GEOGRAPHY_DISCIPLINE_ID})`,
    );
  } catch (error) {
